...
export default class Product {
    ...
    static async singleProductModal(productId) {
        ...
        product.category.toLowerCase() === "pizza" ? isPizza = true : isPizza = false;
        ...
        const toppingsSectionHtml =
            ...
            `
                ...
                // Display the Ingredienst and make them active, when user click on it will deselect it showing it is not wanted
        ...
        domBody.innerHTML = `
            <div class="product-layout ${!isPizza ? 'single-layout' : ''}">
                <div class="product-left">
                    <img src="${imageUrl}" alt="${product.name}" class="product-image ${product.category.toLowerCase() === 'pizza' ? 'spin' : 'zoom'}">
